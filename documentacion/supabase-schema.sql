-- Справочный снимок схемы приложения (порядок: зависимости сверху вниз).
-- Миграции — источник правды: supabase/migrations/
...
-- Storage: bucket content-images (см. миграцию), публичное чтение объектов для next/image.
